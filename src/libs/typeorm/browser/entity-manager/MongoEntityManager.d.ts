...
export declare class MongoEntityManager extends EntityManager {
     ...
     */
    protected convertFindOptionsSelectToProjectCriteria(selects: FindOptionsSelect<any> | FindOptionsSelectByString<any>): FindOptionsSelect<any> | {
        [key: string]: number;
        [key: number]: number;
        [key: symbol]: number;
    };
     ...
     */
    protected applyEntityTransformationToCursor<Entity extends ObjectLiteral>(metadata: EntityMetadata, cursor: Cursor<Entity> | AggregationCursor<Entity>, entityClassOrName: EntityTarget<Entity>): void;
